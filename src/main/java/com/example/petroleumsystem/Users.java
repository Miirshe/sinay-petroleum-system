...
public class Users implements Initializable {
    ...
    String [] rollType = {"user","admin"};
    ObservableList<String> users = FXCollections.observableArrayList(rollType);
//    @FXML
//    private ComboBox<String> comboUsers;
    @FXML
    private ChoiceBox<String> comboUsers;
    @FXML
    void FetchComboUsers() {
        comboUsers.getItems().addAll("user","admin");
    }
    @FXML
    ...
    void getTableOfData(MouseEvent event) {
       ...
       ObservableList<String> users = FXCollections.observableArrayList(userClass.getRoll_type());
...
//       txtUserRollType.setText(userClass.getRoll_type());
   ...
   public void BinddataView () throws SQLException {
    ...
    void OnSaveUser(ActionEvent event) throws SQLException , IOException {
        ...
        try{
            if(txtUserName.getText().isEmpty() || txtUserEmail.getText().isEmpty() || comboUsers.getItems().isEmpty() || txtUserQuestion.getText().isEmpty() || txtUserAnswer.getText().isEmpty() || txtUserPassword.getText().isEmpty()
            ){
                ...
                String roll_type = comboUsers.getSelectionModel().getSelectedItem();
    ...
    void OnEditUser(ActionEvent event) throws SQLException , IOException {
        ...
        try{
            if(txtUserName.getText().equals("") || txtUserEmail.getText().equals("") || comboUsers.getItems().isEmpty() || txtUserQuestion.getText().equals("") || txtUserAnswer.getText().equals("") || txtUserPassword.getText().equals("")
            ){
                Alert alert = new Alert(Alert.AlertType.ERROR);
