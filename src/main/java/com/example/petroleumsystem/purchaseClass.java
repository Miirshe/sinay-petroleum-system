...
public class purchaseClass {
    ...
    public purchaseClass(int id , String supplier_name , int supplier_phone , String fuel_type , int tunk_number , int litters , double per_litters , double total_price , Date date , String status){
        this.id = id;
